export const nameMapping = {
    cardbanks: {
        ...
        axis: ["axis bank", "axis", "utibr", "utib", "axisc", "utibc"],
        bdnc: ["bandhan bank", "bandhan", "bdnc", "bdblc", "bdnr", "bdblr"],
        bobc: ["bobc", "bank of baroda", "barbc", "bob", "bobr", "barbr"],
        ...
        icici: ["icici", "icici bank", "icicir", "icicic", "icici corp nb"],
        idfc: ["idfc", "idfc bank", "idfc first bank", "idfbr"],
        indian: ["indian", "indian bank", "idibr"],
        indusind: ["indusind", "indusind bank", "indbr", "indus ind"],
        iob: [
            "iob",
            "iob bank",
        ...
        lvbc: ["lvbc", "lavbc", "lvbr", "lvb", "lavbr", "laxmi vilas bank"],
        pnbc: [
            "pnbc",
            "pnb",
        ...
        sbi: ["sbi", "state bank of india", "sbinr", "sbic", "sbinc"],
        scb: [
            "scb",
            "standard chartered",
        ...
        tammerc: ["tammerc", "tammerc bank", "tamilnad mercantile bank"],
        uco: [
            "uco",
            "uco bank",
        ...
        bclc: ["barclays", "bclc"],
        cpb: ["capital small finance", "cpb", "capital small finance bank"],
        ...
        jsb: ["jsb", "janata sahakari bank", "janata sahakari bank pune"],
        ...
        pnsb: ["pnsb", "punjab and sind bank", "punjab & sind bank"],
        svcb: [
            "svcb",
